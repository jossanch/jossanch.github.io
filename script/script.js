...
/* --------- */
let menuItems,
    rowReggaeton = document.querySelector("#row-reggaeton"),
    rowElectronica = document.querySelector("#row-electronica"),
    rowNacionales = document.querySelector("#row-nacionales"),
...
function updateOrder(clean) {
    ...
    order = [];
    form.innerHTML = '<input type="hidden" name="_next" value="jossanch.github.io"><input type="hidden" name="_captcha" value="false">'; 
...
function createMenuCard(type, description, price, available, source) {
    ...
    switch (type) {
        case "Reggaeton":
            rowReggaeton.appendChild(divCol);
            break;
        case "Electronica":
            rowElectronica.appendChild(divCol);
            break;
        case "Nacionales":
            rowNacionales.appendChild(divCol);
            break;
    }
...
function createSettingsRow(type, description, price, available, source) {
    ...
    option1.value = "Reggaeton";
    option1.textContent = "Reggaeton";
    inputType.appendChild(option1);
    let option2 = document.createElement("option");
    option2.value = "Electronica";
    option2.textContent = "Electronica";
    inputType.appendChild(option2);
    let option3 = document.createElement("option");
    option3.value = "Nacionales";
    option3.textContent = "Nacionales";
...
function createMenuAndSettings(products) {
    ...
    rowReggaeton.innerHTML = "";
    rowElectronica.innerHTML = "";
    rowNacionales.innerHTML = "";
